export const id = "EVENT_COPY_BKG_SUBMAP_TO_BKG_TILESET_LEGACY";
export const name = "Copy scene submap to background tileset (GBS 3)";
export const groups = ["EVENT_GROUP_SCREEN"];

export const autoLabel = (fetchArg) => {
  return `Copy scene submap to background tileset (GBS 3)`;
};
...
export const compile = (input, helpers) => {
  ...
  _addComment("Copy scene submap to background (GBS 3) tileset");
