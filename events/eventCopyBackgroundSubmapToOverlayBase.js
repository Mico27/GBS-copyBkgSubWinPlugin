...
export const name = "Copy background submap to overlay with tile offset";
export const groups = ["EVENT_GROUP_SCREEN"];

export const autoLabel = (fetchArg) => {
  return `Copy background submap to overlay with tile offset`;
};
...
export const compile = (input, helpers) => {
  ...
  _addComment("Copy background submap to overlay with tile offset");
